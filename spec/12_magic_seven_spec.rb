...
describe MagicSeven do
  ...
  describe '#divide_by_two' do
    context 'when the previous step is 6' do
      it 'returns 3' do
        previous_step = 6
  ...
  describe '#subtract_random_number' do
    subject(:game) { MagicSeven.new(5) }

    context 'when the previous step is 3' do 
      it 'returns 3 minus initial number' do
        previous_step = 3
  ...
  describe '#play' do
    context 'when the random number is 500' do
      subject(:game) { MagicSeven.new(500) }
    ...
    context 'when the random number is 321' do
      subject(:game) { MagicSeven.new(321) }
